    ...
    return class Store {
        ...
        add(ucan) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const chains = [];
                try {
                    for (var _c = __asyncValues((0, attenuation_js_1.delegationChains)(plugins)(this.knownSemantics, ucan)), _d; _d = yield _c.next(), !_d.done;) {
        ...
        *findWithCapability(audience, requiredCapability, requiredIssuer) {
            ...
            for (const cacheElement of cache) {
                for (const delegationChain of cacheElement.capabilities) {
                    if ((0, attenuation_js_1.capabilityCanBeDelegated)(this.knownSemantics, requiredCapability, delegationChain)
                        && (0, attenuation_js_1.rootIssuer)(delegationChain) === requiredIssuer) {
