...
exports.ownershipCanBeDelegated = exports.capabilityCanBeDelegated = exports.equalCanDelegate = exports.rootIssuer = exports.delegationChains = void 0;
 ...
 */
const delegationChains = (plugins) => function (semantics, ucan, isRevoked = () => __awaiter(this, void 0, void 0, function* () { return false; })) {
...
exports.delegationChains = delegationChains;
/**
...
exports.equalCanDelegate = {
    ...
    canDelegateAbility(parentAbility, childAbility) {
        if (parentAbility === super_user_js_1.SUPERUSER) {
            return true;
        }
        if (childAbility === super_user_js_1.SUPERUSER) {
            return false;
        }
...
function ownershipCanBeDelegated(semantics, did, scope, fromDelegationChain) {
    ...
    if (parentScope === super_user_js_1.SUPERUSER) {
        return true;
    }
    if (scope === super_user_js_1.SUPERUSER) {
        return false;
    }
    return parentScope.scheme === scope.scheme
        && semantics.canDelegateAbility(parentScope.ability, scope.ability);
}
exports.ownershipCanBeDelegated = ownershipCanBeDelegated;
// ㊙️ Internal
function* capabilitiesFromParenthood(ucan) {
    for (const capability of ucan.payload.att) {
        switch (capability.with.scheme.toLowerCase()) {
            ...
            case "my": {
                const scope = capability.with.hierPart === super_user_js_1.SUPERUSER
...
function handleAsDelegation(plugins, semantics, capability, ucan, proof, isRevoked) {
    return __asyncGenerator(this, arguments, function* handleAsDelegation_1() {
        ...
        const scope = scheme === super_user_js_1.SUPERUSER
            ? super_user_js_1.SUPERUSER
            : { scheme, ability: capability.can };
        try {
            for (var _b = __asyncValues((0, exports.delegationChains)(plugins)(semantics, proof, isRevoked)), _c; _c = yield __await(_b.next()), !_c.done;) {
...
function handlePrfDelegation(plugins, semantics, capability, ucan, proof, proofIndex, isRevoked) {
    return __asyncGenerator(this, arguments, function* handlePrfDelegation_1() {
        var e_3, _a;
        if (capability.with.hierPart !== super_user_js_1.SUPERUSER
