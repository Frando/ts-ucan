...
import { capabilityCanBeDelegated, delegationChains, equalCanDelegate, rootIssuer } from "./attenuation.js";
import { isCapability } from "./capability/index.js";
 ...
 */
export const verify = (plugins) => (ucan, options) => __awaiter(void 0, void 0, void 0, function* () {
    var e_1, _a;
    var _b, _c, _d;
    const { audience, requiredCapabilities } = options;
    const semantics = (_b = options.semantics) !== null && _b !== void 0 ? _b : equalCanDelegate;
    ...
    try {
        ...
        try {
            ...
            loop: for (var _e = __asyncValues(delegationChains(plugins)(semantics, decoded, isRevoked)), _f; _f = yield _e.next(), !_f.done;) {
                ...
                for (const expected of remaining) {
                    if (capabilityCanBeDelegated(semantics, expected.capability, delegationChain)
